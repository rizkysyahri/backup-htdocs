...
var hitung = (document.getElementById('hrgbelitxt').value * document.getElementById('jmltxt').value);
...
<form id="form1" name="form1" method="post" action="home.php?go=Pembelian_Simpan">
  <table width="700" border="0" align="center">
    ...
    <tr>
      ...
      <td align="left" valign="middle">:</td>
      <td align="left" valign="top"><input name="hrgbelitxt" type="text" id="hrgbelitxt" size="5" maxlength="15" readonly="readonly" /></td>
