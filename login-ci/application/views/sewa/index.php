  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <thead class="thead-dark">
			...
			<?php
			if( ! empty($sewa)){ // Jika data siswa tidak sama dengan kosong, artinya jika data siswa ada
				foreach($sewa as $data){
					...
					<td>".$data->telp."</td>
					<td>".$data->alamat."</td>
						<td><a href='".base_url("index.php/sewa/hapus/".$data->id)."'>Hapus</a></td>
					</tr>";
				}
