...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="row">
            <div class="col">
            <i class="fa-solid fa-image-portrait me-2"></i>Nomor Induk Kependudukan
      ...
      <div class="row">
        ...
        <div class="row">
            <div class="col">
            <i class="fa-solid fa-phone me-2"></i>No Telepon
        ...
        <div class="row">
            <div class="col">
            <i class="fa-solid fa-user-tie me-2"></i>Jabatan
                ...
                <form>
                    <fieldset disabled>
                        <div class="row">
                            ...
                            <div class="col-12">
                            <label class="form-label"><i class="fa-solid fa-file-signature me-2"></i>Nama Lengkap</label>
                            ...
                            <div class="col-md-6">
                            <label class="form-label"><i class="fa-solid fa-phone me-2"></i>No Telepon</label>
                            ...
                            <div class="col-md-6">
                            <label class="form-label"><i class="fa-solid fa-user-tie me-2"></i>Jabatan</label>
      ...
      <footer>
<div class="bg-light border text-center pt-4 pb-4 fixed" style="margin-top: 14%; background-color: rgba(0, 0, 0, 0.2)">
        <p class="text-dark fw-bold">Copyright 2022 <span> @<?php echo $_SESSION['nama_login']?></span></p>
    </div>
</footer>
